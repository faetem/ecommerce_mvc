...
<div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    <div>
        <h2>Bienvenue dans la forêt d'Amazonie !</h2>
        <!-- <img src="https://plus.unsplash.com/premium_photo-1730078556315-9ca0a48965ec?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" style="max-width: 1200px; margin: 0 auto; padding: 20px; opacity: 0.5;"></img> -->
        <p>Penchez-vous vers les dernières nouveautés.</p>
    </div>
    ...
    <div style="margin-top: 30px; display: flex; justify-content: flex-end;">
        ...
        <a href="/products" style="padding: 10px 20px; background-color: #ffc107; color: #000; text-decoration: none; border-radius: 4px; font-weight: bold;">
