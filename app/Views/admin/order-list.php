...
<div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    ...
    <?php if (empty($orders)): ?>
        <div style="text-align: center; padding: 60px; background-color: #f8f9fa; border-radius: 8px;">
            ...
            <p style="color: #999; margin-bottom: 30px;">Aucune commande passée pour l'instant.</p>
    ...
    <div style="margin-top: 30px; text-align: center;">
        <a href="/admin" style="color: #007bff; text-decoration: none;">← Retour au Dashboard</a>
    </div>
</div>
