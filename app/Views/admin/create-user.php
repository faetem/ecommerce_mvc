...
<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <form method="POST" action="/admin/create-user" id="userForm" style="display: flex; flex-direction: column; gap: 15px;">
        <div>
        ...
        <div>
            <label for="role" style="display: block; margin-bottom: 5px; font-weight: bold;">Rôle :</label>
            <select id="role" name="role" required 
                style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; background-color: white;">
    ...
    <div style="margin-top: 20px;">
        <a href="/admin/users" style="color: #007bff; text-decoration: none;">← Retour</a>
    </div>
</div>
